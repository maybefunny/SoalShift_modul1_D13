...
awk -F, '{if($1=="United States" && $7=="2012" && ($4=="Personal Accessories" || $4=="Camping Equipment" || $4=="Outdoor Protection")) a[$5]+=$10;} END{for(i in a) print a[i]"  "i}' WA_Sales_Products_2012-14.csv | sort -n -r | head -n 3 | awk '{print $2}'